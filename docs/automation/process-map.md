...
| P-19 | unsubscribe | — | — | — | — | — | — | **не існує** — маркетингових розсилок ще немає взагалі | не реалізовано (Етап 3+, залежить від O-06) |
...
| P-22 | daily owner digest | — | — | — | — | — | — | не існує | не реалізовано (Етап 7, потребує O-14 канал сповіщень) |
